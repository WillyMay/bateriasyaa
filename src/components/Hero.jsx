...
function Hero() {
  return (
    ...
    <div className="py-40 px-4 mx-auto text-center lg:px-12 bg-[url('https://i.postimg.cc/4xLBqvNY/repair-man-making-car-service.webp')] bg-cover">
        ...
        <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            <a href="https://wa.link/sn7pf8" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                Nuestro WhatsApp
